...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ razorbacks\style\Manifest::cdn() }}/images/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{{ razorbacks\style\Manifest::cdn() }}/images/32x32.png">

...
manifestphp=php/src/Manifest.php

# set RAZORBACKS_STYLE_CDN Manifest class constant
sed -r -i "s~const RAZORBACKS_STYLE_CDN = '.*'~const RAZORBACKS_STYLE_CDN = '$RAZORBACKS_STYLE_CDN'~" $manifestphp

# add version to script
sed -r -i "s/const VERSION = '.+\-dev'/const VERSION = '$1'/" $manifestphp
...
# bump to -dev
sed -i "s/const VERSION = '$1'/const VERSION = '$1-dev'/" $manifestphp
